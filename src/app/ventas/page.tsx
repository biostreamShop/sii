...
function VentasContent() {
  ...
  const handleExport = () => {
    ...
    link.href = url;
    link.download = `ventas_${year}_${month || "anual"}.csv`;
    link.click();
  };
  ...
  if (!data?.transactions.length && !loading) {
    return (
      <div className="p-8">
        <h1 className="text-2xl font-bold text-gray-900 mb-8">Ventas</h1>
        <div className="bg-blue-50 border border-blue-200 rounded-xl p-8 text-center">
          ...
          <p className="text-blue-600 mb-6">
            Importa tu archivo CSV de ventas para ver los registros aquí.
          </p>
          <Link
            href="/importar"
